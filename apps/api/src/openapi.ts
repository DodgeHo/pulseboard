export const openApiDocument = {
  ...
  paths: {
    '/demo/health/live': { get: { security: [], summary: 'Liveness check', responses: { 200: { description: 'Alive' } } } },
    '/demo/health/ready': { get: { security: [], summary: 'Readiness check', responses: { 200: { description: 'Ready' }, 503: { description: 'Not ready' } } } },
